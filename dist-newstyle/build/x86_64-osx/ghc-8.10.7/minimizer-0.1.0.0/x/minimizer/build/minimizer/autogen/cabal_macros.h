...
/* package minimizer-0.1.0.0 */
#ifndef VERSION_minimizer
#define VERSION_minimizer "0.1.0.0"
#endif /* VERSION_minimizer */
#ifndef MIN_VERSION_minimizer
#define MIN_VERSION_minimizer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_minimizer */
...
#define CURRENT_COMPONENT_ID "minimizer-0.1.0.0-inplace-minimizer"
